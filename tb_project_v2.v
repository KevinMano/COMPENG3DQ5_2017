...
//`define VERIFICATION_FILE_NAME "cat.sram_d2"
//`define VERIFICATION_FILE_NAME "chip.sram_d0"
//`define VERIFICATION_FILE_NAME "chip.sram_d1"
//`define VERIFICATION_FILE_NAME "chip.sram_d2"
//`define VERIFICATION_FILE_NAME "panda.sram_d0"
//`define VERIFICATION_FILE_NAME "panda.sram_d1"
//`define VERIFICATION_FILE_NAME "panda.sram_d2"
...
//`define INPUT_FILE_NAME "panda.mic11"
...
begin
	...
	for (i=76800; i<262144; i=i+1) begin				//0
...
begin
	...
	//Milestone 1: cut and paste --> 146944; i<262144
...
always @ (posedge Clock_50) begin
	if (uut.SRAM_we_n == 1'b0) begin	//signal names within project (instantiated as uut) should match here, assuming names from experiment4a
		...
		if (uut.SRAM_address > 76800) begin//< 146944) begin
