...
vlog -sv -svinputport=var -work rtl_work address_generator.v
vlog -sv -svinputport=var -work rtl_work C_values.v
vlog -sv -svinputport=var -work rtl_work project_mem1.v
vlog -sv -svinputport=var -work rtl_work project_mem2.v
vlog -sv -svinputport=var -work rtl_work multiplier.v
vlog -sv -svinputport=var -work rtl_work tb_project_v2.v
vlog -sv -svinputport=var -work rtl_work milestone3.v
#vlog -sv -svinputport=var -work rtl_work variable_shifter.v
vlog -sv -svinputport=var -work rtl_work M3_Interface_RAM.v
vlog -sv -svinputport=var -work rtl_work variable_shifter2.v
